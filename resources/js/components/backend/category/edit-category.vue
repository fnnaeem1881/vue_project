           ...
           <div class="col-6 pt-3 offset-3">
            ...
            <form @submit.prevent="editCategory">
                ...
                <div class="card-footer">
                  <button type="submit" :disabled="form.busy" class="btn btn-primary">Update Category</button>
                  <router-link to="/categoris" class="btn btn-danger float-right">
                    Cancel
                  </router-link>
                </div>
              </form>
...
<script>
    ...
    methods: {
        editCategory:function(){
            ...
            //alert(CatId);
            let test = this;
            this.form.post('/categoryEditStore/' +CatId)
            .then(function(data){
                Toast.fire({
                icon: 'success',
        ...
        edit(id){
            let test = this;
             axios.get("categoryEdit/" +test.$route.params.id)
